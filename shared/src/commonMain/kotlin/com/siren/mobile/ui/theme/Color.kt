 ...
 * than these directly, so the whole app restyles from one place.
 *
 ...
 *
 * The app is light-only (see `SirenTheme`), so this palette assumes light surfaces
 * throughout. The former on-dark variants were removed with the dark scheme.
 */
